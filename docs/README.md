...
第一次写插件的话,按 `dev-guide.md` → [CLI 手册](https://github.com/joesdu/velashell-plugin-cli/blob/main/docs/cli.md) → `publishing.md` 的顺序读。
...
| **SDK 参考**(契约表面、能力域一览、版本历史) | [velashell-plugin-sdk / docs/sdk-reference.md](https://github.com/joesdu/velashell-plugin-sdk/blob/main/docs/sdk-reference.md) |
