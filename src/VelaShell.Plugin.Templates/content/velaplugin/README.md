...
<https://github.com/joesdu/velashell-plugin-templates/blob/main/docs/publishing.md>。
...
命令行工具手册:<https://github.com/joesdu/velashell-plugin-cli/blob/main/docs/cli.md>
